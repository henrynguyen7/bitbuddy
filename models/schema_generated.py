"""
schema.py TEST FILE, CURRENTLY UNVERFIED.

This is a test db schema file produced by an automated generator which takes a SQL script (.sql) file
and converts it into corresponding web2py define_table statements. CURRENTLY UNVERFIED. Other than the DAL() 
initialization statement, this file should be equivalent to schema.py which was manually written, although
it may contain more detail on field attributes.
"""
