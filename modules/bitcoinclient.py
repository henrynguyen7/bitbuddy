...
class BitcoinClient:
    ...
    def dumpprivkey(self, bitcoinaddress):
        ...
        """
        self.bitcoind.dumpprivkey(bitcoinaddress)
    ...
    def encryptwallet(self, passphrase):
        ...
        """
        self.bitcoind.encryptwallet(passphrase)
    ...
    def getaccount(self, bitcoinaddress):
        ...
        """
        self.bitcoind.getaccount(bitcoinaddress)
    ...
    def getaddressesbyaccount(self, account):
        ...
        """
        self.bitcoind.getaddressesbyaccount(account)
    ...
    def getbalance(self, account=None, minconf=1):
        ...
        """
        self.bitcoind.getbalance(account, minconf)
    ...
    def listsinceblock(self, blockhash, target-confirmations):
        """Get all transactions in blocks since block [blockhash], or all transactions if omitted.
        
        blockhash:
        target-confirmations: 
        """
        return self.bitcoind.listsinceblock(blockhash, target-confirmations)
    
    def listtransactions(self, account, count=10, from=0):
        ...
        from: 
        """
        return self.bitcoind.listtransactions(account, count, from)
    ...
    def listunspent(self, minconf=1, maxconf=999999):
        ...
        maxconf: 
        """
        return self.bitcoind.listunspent(account, count, from)
    ...
    def sendfrom(self, fromaccount, tobitcoinaddress, amount, minconf=1, comment=None, comment-to=None):
        ...
        """
        return self.bitcoind.sendfrom(fromaccount, tobitcoinaddress, amount, minconf, comment, comment-to)
    
    def sendmany(self):
    
    def sendrawtransaction(self):
    
    def sendtoaddress(self, bitcoinaddress, amount, comment=None, comment-to=None):
        ...
        comment-to: optional comment-to
        """
        return self.bitcoind.sendtoaddress(bitcoinaddress, amount, comment, comment-to)
    ...
    def settxfee(self, amount):
        ...
        """
        return self.bitcoind.setaccount(amount)
